...
#ifndef SUBTTXREND_COMMON_LOGGERBACKENDRDK_HPP_
#define SUBTTXREND_COMMON_LOGGERBACKENDRDK_HPP_
 ...
 *
 * Uses RDK logger internally.
 */
class LoggerBackendRdk : public LoggerBackend,
                         private NonCopyable
{
public:
    /** Constructor. */
    ...
    /** Destructor. */
    virtual ~LoggerBackendRdk();

    /**
     * Checks if backend was initialized.
     *
     * @retval true
     ...
     *
     * @param rdkConfigFileName
     *      Name of the RDK logger configuration file.
     *
     * @retval true
     *      Success.
     * @retval false
     *      Failure.
     */
    bool init(const std::string& rdkConfigFileName);
