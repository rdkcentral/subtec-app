...
message(STATUS "PC_LIBGLIB_LINK_LIBRARIES = ${PC_LIBGLIB_LINK_LIBRARIES}")

if(CMAKE_SYSTEM_NAME STREQUAL Darwin)
    # Trust the find_package tool
    set(LIBGLIB_INCLUDE_DIR ${PC_LIBGLIB_INCLUDEDIR})
    set(LIBGLIB_CONFIG_INCLUDE_DIR ${PC_LIBGLIB_INCLUDEDIR})
    set(LIBGLIB_LIBRARY ${PC_LIBGLIB_LINK_LIBRARIES})
else()
...
if(CMAKE_SYSTEM_NAME STREQUAL Darwin)
    set(LIBGLIB_INCLUDE_DIRS ${LIBGLIB_INCLUDE_DIR} ${PC_LIBGLIB_INCLUDE_DIRS})
else()
