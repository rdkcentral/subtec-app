...
#ifndef _SUBTTXREND_DBUS_DBUSHANDLERTELETEXT_HPP_
#define _SUBTTXREND_DBUS_DBUSHANDLERTELETEXT_HPP_
...
#include "TeletextDbusInterface.h"
...
/**
 * Registers and handles request for dbus Teletext object.
 */
class DbusHandlerTeletext : public common::NonCopyable
{
public:
     ...
     */
    DbusHandlerTeletext(DbusRequestHandler &requestHandler);

    /**
     * Destructor.
     */
    virtual ~DbusHandlerTeletext();
...
private:
     ...
     *
     * @param interface
     *      Teletext GObject where request was received.
     *
     * @param invocation
     ...
     */
    static gboolean onHandleSetMuted(Teletext *interface,
     ...
     *      TRUE if method completed successfully.
     */
    static gboolean onHandleGetStatus(Teletext *interface,
                                      GDBusMethodInvocation *invocation,
                                      gpointer userData);
    ...
    /**
     * Setter for Teletext gObject.
     */
    void setTeletextGObj(Teletext* teletextGObj)
    {
        m_teletextGObj = teletextGObj;
    }
    ...
    /** Registered Teletext dbus object (nullptr if not yet registered). */
    Teletext* m_teletextGObj;
...
#endif /* _SUBTTXREND_DBUS_DBUSHANDLERTELETEXT_HPP_ */
