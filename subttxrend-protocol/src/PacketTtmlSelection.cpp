...
common::Logger PacketTtmlSelection::m_logger("Protocol", "PacketTtmlSelection");

PacketTtmlSelection::PacketTtmlSelection()
    : PacketChannelSpecific{Type::TTML_SELECTION}
...
std::uint32_t PacketTtmlSelection::getRelatedVideoWidth() const
{
    return m_relatedVideoWidht;
}

std::uint32_t PacketTtmlSelection::getRelatedVideoHeight() const
{
    return m_relatedVideoHeight;
}

bool PacketTtmlSelection::parseDataHeader(BufferReader& bufferReader)
{
