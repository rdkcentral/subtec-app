...
@pytest.mark.webvtt
def test_1001():
    print("test_1001".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "-[processWebvttSelection]")
    ...
    log_sequence = [ 'validate - RESET ALL received - resetting stream state',
        ...
        'Selecting WebVTT Subtitles',
        'WebvttController created',
        '-[processWebvttSelection]']
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1001 missing"

    print("test_1001".ljust(50), "Test Passed")