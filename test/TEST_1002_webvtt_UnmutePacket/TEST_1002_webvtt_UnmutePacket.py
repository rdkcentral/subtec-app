...
@pytest.mark.webvtt
def test_1002():
    print("test_1002".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "[WebvttEngine::WebVTTRenderer] show")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1002 missing"

    print("test_1002".ljust(50), "Test Passed")