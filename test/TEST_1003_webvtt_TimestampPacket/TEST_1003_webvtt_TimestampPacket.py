...
@pytest.mark.webvtt
def test_1003():
    print("test_1003".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1003 missing"

    print("test_1003".ljust(50), "Test Passed")