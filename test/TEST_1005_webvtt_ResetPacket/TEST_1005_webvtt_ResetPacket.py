...
@pytest.mark.webvtt
def test_1005():
    print("test_1005".ljust(50), "Test Started")
    ...
    log_sequence = [
        ...
        'reset All']
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1005 missing"

    print("test_1005".ljust(50), "Test Passed")