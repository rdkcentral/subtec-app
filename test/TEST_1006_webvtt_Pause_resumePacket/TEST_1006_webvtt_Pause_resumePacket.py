...
@pytest.mark.webvtt
def test_1006():
    print("test_1006".ljust(50), "Test Started")
    ...
    sequence = [
        ...
        'resume received']
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1006 missing"

    print("test_1006".ljust(50), "Test Passed")
