...
@pytest.mark.webvtt
def test_1008():
    print("test_1008".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "displaying: [00:00:05.000-00:00:10.000]: nopqrstuvwxyz")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1008 missing"

    print("test_1008".ljust(50), "Test Passed")