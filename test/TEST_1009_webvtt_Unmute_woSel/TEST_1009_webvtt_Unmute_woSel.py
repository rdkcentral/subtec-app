...
@pytest.mark.webvtt
def test_1009():
    print("test_1009".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1009 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1009 incorrect"

    print("test_1009".ljust(50), "Test Passed")
