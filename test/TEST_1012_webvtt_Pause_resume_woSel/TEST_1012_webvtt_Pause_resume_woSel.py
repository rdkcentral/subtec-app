...
@pytest.mark.webvtt
def test_1012():
    print("test_1012".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1012 missing"
    ...
    log_sequence = ['onPacketReceived packet=type:WEBVTT_SELECTION', 
        ...
        'resume received']
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1012 incorrect"

    print("test_1012".ljust(50), "Test Passed")
