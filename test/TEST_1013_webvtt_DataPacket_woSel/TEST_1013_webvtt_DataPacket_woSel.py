...
@pytest.mark.webvtt
def test_1013():
    print("test_1013".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1013 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1013 incorrect"

    print("test_1013".ljust(50), "Test Passed")
