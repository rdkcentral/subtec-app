...
@pytest.mark.webvtt
def test_1014():
    print("test_1014".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "-[processDataPacket]")
    time.sleep(2)
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1014 missing"

    # Give strings that are not expected in log
    log_sequence = ['onPacketReceived packet=type:WEBVTT_TIMESTAMP', 
        'displaying: [00:00:00.000-00:00:05.000]: abcdefghijklm',
        'displaying: [00:00:05.000-00:00:10.000]: nopqrstuvwxyz']
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1014 incorrect"

    print("test_1014".ljust(50), "Test Passed")
