...
def test_1022():
    print("test_1022".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "displaying: [00:00:00.000-00:00:05.000]: Test Background color - cyan")
    ...
    sequence = [
        ...
        'new value for attibId[0x2] = -16777216', 
        'displaying: [00:00:00.000-00:00:05.000]: Test Background color - embedded', 
        '']
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1022 missing"
    ...
    print("test_1022".ljust(50), "Test Passed")