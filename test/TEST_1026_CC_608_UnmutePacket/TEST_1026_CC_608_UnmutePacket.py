...
@pytest.mark.cc_608
def test_1026():
    print("test_1026".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "[ClosedCaptions::CcController] unmute - done")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1026 missing"

    print("test_1026".ljust(50), "Test Passed")