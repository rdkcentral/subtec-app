...
@pytest.mark.cc_608
def test_1027():
    print("test_1027".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1027 missing"

    print("test_1027".ljust(50), "Test Passed")