...
@pytest.mark.cc_608
def test_1029():
    print("test_1029".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1029 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1029 incorrect"

    print("test_1029".ljust(50), "Test Passed")