...
@pytest.mark.cc_608
def test_1031():
    print("test_1031".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1031 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1031 incorrect"

    print("test_1031".ljust(50), "Test Passed")