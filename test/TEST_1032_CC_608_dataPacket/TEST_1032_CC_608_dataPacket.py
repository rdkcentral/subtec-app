...
@pytest.mark.cc_608
def test_1032():
    print("test_1032".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1032 missing"

    print("test_1032".ljust(50), "Test Passed")