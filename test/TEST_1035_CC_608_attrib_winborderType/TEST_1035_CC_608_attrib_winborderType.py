...
def test_1035():
    print("test_1035".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1035 missing"
    ...
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1035 missing"
    ...
    print("test_1035".ljust(50), "Test Passed")