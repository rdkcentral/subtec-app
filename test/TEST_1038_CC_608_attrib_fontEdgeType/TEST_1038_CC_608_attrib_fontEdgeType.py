...
def test_1038():
    print("test_1038".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "[ClosedCaptions::TextGfxDrawer] draw text:[swe: 00:00:32:00]")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1038 missing"
    ...
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1038 missing"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=28"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=34"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=40"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=46"
    marker_string2 = "[ClosedCaptions::TextGfxDrawer] draw text:[swe: 00:00:32:00]"
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1038 missing"

    print("test_1038".ljust(50), "Test Passed")