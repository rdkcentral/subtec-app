...
@pytest.mark.cc_708
def test_1041():
    print("test_1041".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1041 missing"

    print("test_1041".ljust(50), "Test Passed")