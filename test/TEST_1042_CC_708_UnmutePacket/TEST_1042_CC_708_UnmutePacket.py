...
@pytest.mark.cc_708
def test_1042():
    print("test_1042".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1042 missing"

    print("test_1042".ljust(50), "Test Passed")