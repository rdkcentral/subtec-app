...
@pytest.mark.cc_708
def test_1045():
    print("test_1045".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1045 missing"
    ...
    log_sequence = ['onPacketReceived packet=type:SUBTITLE_SELECTION',
        ...
        'mute (0)',
        '[ClosedCaptions::CcController] unmute',
        'setVisible visible=1',
        '[ClosedCaptions::CcController] unmute - done']
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1045 incorrect"

    print("test_1045".ljust(50), "Test Passed")