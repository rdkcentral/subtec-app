...
@pytest.mark.cc_708
def test_1047():
    print("test_1047".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1047 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1047 incorrect"

    print("test_1047".ljust(50), "Test Passed")