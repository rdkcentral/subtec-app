...
@pytest.mark.cc_708
def test_1048():
    print("test_1048".ljust(50), "Test Started")
    ...
    sequence = [
        ...
        '[ClosedCaptions::TextGfxDrawer] draw text:[was made possible in part by]',
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1048 missing"

    print("test_1048".ljust(50), "Test Passed")