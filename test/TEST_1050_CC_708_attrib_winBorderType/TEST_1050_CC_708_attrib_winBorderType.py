...
def test_1050():
    print("test_1050".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1050 missing"

    sequence = [
        'new value for attibId[0x20] = 3',
        'new value for attibId[0x1] = 16711680',
        'new value for attibId[0x200] = 65280',
        'new value for attibId[0x100] = 4',
    ...
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1050 missing"

    sequence = [
        'new value for attibId[0x200] = 16711680',
        'new value for attibId[0x100] = 5',
        ]
    ...
    sequence = [
        ...
        'new value for attibId[0x100] = 2',
        ]
    marker_string1 = "[ClosedCaptions::TextGfxDrawer] draw text:[was made possible in part by]"
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1), "Logs for test_1050 missing"

    sequence = [
        'new value for attibId[0x200] = 16711680',
        'new value for attibId[0x100] = 3',
        ]
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=159"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:[was made possible in part by]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1050 missing"

    sequence = [
        'new value for attibId[0x200] = 65280',
        'new value for attibId[0x100] = 1',
    ...
    print("test_1050".ljust(50), "Test Passed")