...
def test_1054():
    print("test_1054".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "[ClosedCaptions::TextGfxDrawer] draw text:[your PBS station]")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x20] = 3',
        'new value for attibId[0x2] = 0',
        'new value for attibId[0x1] = 0',
    ...
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x1] = 16777215',
        '[ClosedCaptions::TextGfxDrawer] draw text:[[Wind blowing]]',
        ]
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=86"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=117"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:["Wild Scandinavia"]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x1] = 65280',
        ]
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=133"
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=154"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:[ndation,]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x1] = 16776960',
        '[ClosedCaptions::TextGfxDrawer] draw text:[a grant from]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[Anne Ray Fou]',
        ]
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=170"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:[ndation,]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x1] = 16711935',
        '[ClosedCaptions::TextGfxDrawer] draw text:[a grant from]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[Anne Ray Fou]',
    ...
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=181"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:[anthropy.]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    sequence = [
        'new value for attibId[0x1] = 65535',
        '[ClosedCaptions::TextGfxDrawer] draw text:[a Margaret]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[ A. Cargill]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[Phil]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[anthropy.]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[and by c]',
        '[ClosedCaptions::TextGfxDrawer] draw text:[ontributions to]',
        ]
    marker_string1 = "onPacketReceived packet=type:SET_CC_ATTRIBUTES counter=197"
    marker_string2 = '[ClosedCaptions::TextGfxDrawer] draw text:[your PBS station]'
    assert check_logs_between_strings(subtec_copy_path, sequence, marker_string1, marker_string2), "Logs for test_1054 missing"

    print("test_1054".ljust(50), "Test Passed")