...
@pytest.mark.ttml
def test_1057():
    print("test_1057".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "TtmlController created", 20)
    ...
    log_sequence = [ 'validate - RESET ALL received - resetting stream state',
        ...
        'Selecting TTML Subtitles',
        'TtmlController created']
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1057 missing"

    print("test_1057".ljust(50), "Test Passed")