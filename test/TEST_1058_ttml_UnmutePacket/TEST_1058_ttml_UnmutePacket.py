...
@pytest.mark.ttml
def test_1058():
    print("test_1058".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "setVisible visible=1", 20)
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1058 missing"

    print("test_1058".ljust(50), "Test Passed")