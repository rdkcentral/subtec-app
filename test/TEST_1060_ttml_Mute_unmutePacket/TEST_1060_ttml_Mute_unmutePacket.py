...
@pytest.mark.ttml
def test_1060():
    print("test_1060".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "displaying: [00:00:16.000-00:00:20.000]: [ ] [This text is added to test mute packet - 15-20 seconds] [ ] [ ]", 20)
    ...
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1060 missing"

    print("test_1060".ljust(50), "Test Passed")