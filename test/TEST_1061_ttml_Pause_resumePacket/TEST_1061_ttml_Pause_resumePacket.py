...
@pytest.mark.ttml
def test_1061():
    print("test_1061".ljust(50), "Test Started")
    ...
    log_sequence = [ 
        ...
        'resume received',
        'getWaitTime waitTime: 0',
        'processLoop no active controller, clearing the data queue']
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1061 missing"

    print("test_1061".ljust(50), "Test Passed")