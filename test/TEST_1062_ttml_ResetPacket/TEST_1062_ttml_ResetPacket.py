...
@pytest.mark.ttml
def test_1062():
    print("test_1062".ljust(50), "Test Started")
    ...
    wait_for_log_string(subtec_log_path, "reset All")
    ...
    log_sequence = [ 
        ...
        'reset All']
    assert monitor_log_for_sequence(subtec_copy_path, log_sequence), "Logs for test_1062 missing"

    print("test_1062".ljust(50), "Test Passed")