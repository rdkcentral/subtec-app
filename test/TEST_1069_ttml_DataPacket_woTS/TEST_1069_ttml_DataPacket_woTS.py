...
@pytest.mark.ttml
def test_1069():
    print("test_1069".ljust(50), "Test Started")
    ...
    assert monitor_log_for_sequence(subtec_copy_path, sequence), "Logs for test_1069 missing"
    ...
    assert validate_string_absence(subtec_copy_path, log_sequence), "Logs for test_1069 incorrect"

    print("test_1069".ljust(50), "Test Passed")