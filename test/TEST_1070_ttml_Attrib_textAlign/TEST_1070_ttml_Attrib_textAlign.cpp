...
{
    debug_log("Test ttml attribute text align started");
    bool ret = false;
    ...
    if (ret)
    {
        ...
        read_file_send_data_packet_ttml("input_files/test_sample_textAlign_left.ttml", channel);
        sleep (6);

        read_file_send_data_packet_ttml("input_files/test_sample_textAlign_right.ttml", channel);
        sleep (6);

        read_file_send_data_packet_ttml("input_files/test_sample_textAlign_center.ttml", channel);
    }
    else
    {
