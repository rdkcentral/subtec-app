...
#ifndef TTXDECODER_PESPACKETREADER_HPP_
#define TTXDECODER_PESPACKETREADER_HPP_
...
{
    /**
     * Checks if packet type is teletext.
     *
     * @return
     *      True if packet type is teletext, false otherwise.
     */
    bool isTeletextPacket() const
    {
...
#endif /*TTXDECODER_PESPACKETREADER_HPP_*/
